...
/* harmony import */ var styled_normalize__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! styled-normalize */ "styled-normalize");
...
/* harmony import */ var _public_static_css_style_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../public/static/css/style.css */ "./public/static/css/style.css");
/* harmony import */ var _public_static_css_style_css__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_public_static_css_style_css__WEBPACK_IMPORTED_MODULE_11__);
...
const GlobalStyle = styled_components__WEBPACK_IMPORTED_MODULE_3__["createGlobalStyle"]`
  ${styled_normalize__WEBPACK_IMPORTED_MODULE_4___default.a}
`;
...
class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_7___default.a {
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(styled_components__WEBPACK_IMPORTED_MODULE_3__["ThemeProvider"], {
      ...
      store: store
    }, __jsx(GlobalStyle, null), __jsx(_src_components_Layout__WEBPACK_IMPORTED_MODULE_8__["default"], null, __jsx(Component, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
      router: router
    }, pageProps))))));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_2___default()(_src_store_createStore__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(next_router__WEBPACK_IMPORTED_MODULE_5__["withRouter"])(MyApp)));
...
const GET_TOP_REPOS = _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0___default()('GET_TOP_REPOS');
const GET_TOP_REPOS_SUCCESS = _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0___default()('GET_TOP_REPOS_SUCCESS');
...
const github = {
  getTopRepos({
    ...
    let path = `${_config__WEBPACK_IMPORTED_MODULE_2__["default"].githubApiEndpoint}/search/repositories?q=language:${lang}&sort=stars&order=desc`;
...
function createMiddlewares({
  ...
  let middlewares = [redux_thunk__WEBPACK_IMPORTED_MODULE_2___default.a];

  if (_config__WEBPACK_IMPORTED_MODULE_6__["default"].env === 'development' && false) {
    middlewares.push(Object(redux_logger__WEBPACK_IMPORTED_MODULE_3__["createLogger"])({
      ...
      stateTransformer: state => {
        ...
        for (let i of _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(state)) {
...
function immutableChildren(obj) {
  ...
  _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(obj).forEach(key => {
...
/* harmony default export */ __webpack_exports__["default"] = ((initialState = {}, context) => {
  let {
    isServer
  } = context;
  ...
  return Object(redux__WEBPACK_IMPORTED_MODULE_5__["createStore"])(_reducers__WEBPACK_IMPORTED_MODULE_7__["default"], state, Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_4__["composeWithDevTools"])(Object(redux__WEBPACK_IMPORTED_MODULE_5__["applyMiddleware"])(...middlewares)));
});
